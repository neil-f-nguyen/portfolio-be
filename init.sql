...
('E-Commerce Platform', 'Modern e-commerce platform with online payment and order management.', 'https://dummyimage.com/600x400/000/fff&text=E-Commerce', ARRAY['React', 'TypeScript', 'Node.js', 'PostgreSQL', 'Stripe'], 'https://github.com/tunguyen/ecommerce', 'https://ecommerce.tuportfolio.com', true),
('Task Management App', 'Task management application with intuitive interface and collaboration features.', 'https://dummyimage.com/600x400/000/fff&text=Task+App', ARRAY['Next.js', 'TypeScript', 'TailwindCSS', 'Prisma', 'PostgreSQL'], 'https://github.com/tunguyen/taskapp', 'https://taskapp.tuportfolio.com', false),
('Portfolio Website', 'Personal portfolio website with responsive design and modern UI.', 'https://dummyimage.com/600x400/000/fff&text=Portfolio', ARRAY['Next.js', 'TypeScript', 'TailwindCSS', 'Framer Motion'], 'https://github.com/tunguyen/portfolio', 'https://tuportfolio.com', true);
